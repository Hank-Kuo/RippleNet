...
class RippleNet_head0(nn.Module):
    def __init__(self, args):
        super(RippleNet_head0, self).__init__()
...
class RippleNet_head1(nn.Module):
    def __init__(self, args):
        super(RippleNet_head1, self).__init__()
...
class RippleNet_head2(nn.Module):
    def __init__(self, args):
        super(RippleNet_head2, self).__init__()
