...
parser.add_argument('--dataset_dir', type=str, default='./data/ml-100k', help='where dataset to use')
parser.add_argument('--model_dir', type=str, default='./experiments/base_model', help='Path to model checkpoint (by default train from scratch).')
...
parser.add_argument('--item_update_mode', type=str, default='replace', help='how to update item at the end of each hop')
