...
class RippleNet_item(nn.Module):
    ...
    def forward(
        ...
        o_list, item_embeddings_v1 = self._key_addressing(h_emb_list, r_emb_list, t_emb_list, item_embeddings)
...
class RippleNet_with_head(nn.Module):
    def __init__(self, args, n_entity, n_relation):
        super(RippleNet_with_head, self).__init__()
...
class RippleNet_sampling(nn.Module):
    def __init__(self, args, n_entity, n_relation):
        super(RippleNet_sampling, self).__init__()
